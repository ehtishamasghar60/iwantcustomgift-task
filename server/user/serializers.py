...
from user.utils import EthereumAPI
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_balance(self, obj):
        """
        Get the Ethereum balance using the EthereumAPI class.
        """
        if obj.wallet_address:
            eth_api = EthereumAPI(obj.wallet_address)
            return eth_api.get_balance()
        return None
